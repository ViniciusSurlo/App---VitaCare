      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          ...
          <View style={styles.section}>
            ...
            >
              <View style={styles.settingLeft}>
                <View style={[styles.settingIconBg, { backgroundColor: theme.colors.primary + '15' }]}>
              ...
              <View style={[styles.toggle, { backgroundColor: isDark ? theme.colors.primary : theme.colors.border }]}>
          ...
          <View style={styles.section}>
            ...
            <View style={[styles.aboutCard, { backgroundColor: theme.colors.cardBackground, borderColor: theme.colors.border }]}>
              ...
              <View style={styles.aboutRow}>
                <Text style={[styles.aboutLabel, { color: theme.colors.subText }]}>Desenvolvido por</Text>
                <Text style={[styles.aboutValue, { color: theme.colors.text }]}>Equipe VitaCare</Text>
              </View>
              <View style={[styles.divider, { backgroundColor: theme.colors.border }]} />
              <View style={styles.aboutRow}>
          ...
          <View style={styles.section}>
            <TouchableOpacity
              style={[styles.actionButton, { backgroundColor: theme.colors.primary, shadowColor: theme.colors.primary }]}
              onPress={() => navigation.goBack()}
              activeOpacity={0.8}
            >
          ...
          {/* Footer */}
          <Text style={[styles.footerText, { color: theme.colors.subText }]}>VitaCare © 2025</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  infoContent: { flex: 1 },
  infoTitle: { fontSize: 24, fontWeight: '700', marginBottom: 4, letterSpacing: -0.5 },
  infoSubtitle: { fontSize: 14, fontWeight: '500' },
  section: { marginBottom: 32 },
  sectionTitle: { fontSize: 13, fontWeight: '700', letterSpacing: 1, marginBottom: 12, marginLeft: 4 },
  settingCard: { 
    flexDirection: 'row', 
    alignItems: 'center', 
    justifyContent: 'space-between', 
  ...
  settingInfo: { flex: 1 },
  settingLabel: { fontSize: 17, fontWeight: '600', marginBottom: 4 },
